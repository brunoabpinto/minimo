...
<p class="docs-path">View path: <code>views/markdown/docs-md.md</code></p>
...
- `views/pages`: Blade route views.
- `views/markdown`: Markdown content and markdown Blade layout.
- `views/vue`: route-based `.vue` files.
...
- `/blogpost` -> `views/markdown/blogpost.md`
