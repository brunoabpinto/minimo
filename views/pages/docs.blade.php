    ...
    <section class="docs container">
        <div class="docs-switch" aria-label="Documentation formats">
            ...
            <a class="docs-switch-item" href="/docs-vue">
                <img src="https://cdn.simpleicons.org/vuedotjs/42b883" alt="Vue icon" width="20" height="20"
                    loading="lazy" decoding="async" />
                <span>Vue</span>
            </a>
        ...
        <p>Minimo is a lightweight PHP framework with controller-based routing and a plugin pipeline for rendering.</p>

        <p>Request flow:</p>
        <p><code>public/index.php</code> -> <code>app/Core/core.php</code> -> controller match or plugin pipeline</p>

        <h2>Directory Structure</h2>
        <ul>
            <li><code>app/Controllers</code>: HTTP controllers.</li>
            <li><code>app/Core</code>: framework core (routing and plugin contracts/manager).</li>
            <li><code>app/Plugins</code>: rendering and feature plugins.</li>
            <li><code>views/pages</code>: route files for <code>.blade.php</code>, <code>.vue</code>, and <code>.md</code>.
            </li>
        ...
        <p>Example:</p>
        <ul>
            <li><code>GET /post/comments</code> -> <code>PostCommentsController@index</code></li>
        </ul>
        ...
        <ul>
            ...
            <li><code>/{resource}/{id}</code> -> <code>show($id)</code> when second segment is numeric</li>
        </ul>

        <p>If no controller is matched, plugins handle route resolution.</p>

        <h2>Controllers</h2>
        <p>Controllers live in <code>app/Controllers</code> and are plain PHP classes.</p>
...
class DocsController
{
    ...
    public function show($id)
    {
        ...
        <ul>
            <li>If a controller method returns non-null, core echoes it and exits.</li>
        ...
        <pre><code>public function index()
{
    view(['title' => 'Hello']); // resolves to views/pages/{controller}.blade.php
        ...
        <p>Layout pattern:</p>
        <ul>
            <li><code>views/layouts/app.blade.php</code> includes shared header/footer.</li>
        </ul>
        ...
        <p>How it works:</p>
        <ul>
            <li>Reads <code>&lt;template&gt;</code>, <code>&lt;script&gt;</code>, and <code>&lt;style&gt;</code> from the
                <code>.vue</code> file.</li>
        ...
        <ul>
            ...
            <li><code>script setup</code> is not supported in the current runtime loader.</li>
        </ul>
